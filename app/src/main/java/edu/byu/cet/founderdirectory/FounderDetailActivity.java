...
public class FounderDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(FounderDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(FounderDetailFragment.ARG_ITEM_ID));
            FounderDetailFragment fragment = new FounderDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.founder_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, FounderListActivity.class));
            return true;
        }
